...
{
    /**
     * @Route("/querybooking/{page}", name="query_booking", requirements={"page"="\d+"})
     */
    ...
    /**
     * @Route("/querybooking/add", name="query_booking_add")
     */
    ...
    /**
     * @Route("/querybooking/edit/{queryBookingID}", name="query_booking_edit")
    ...
    /**
       * @Route("/querybooking/modify/{queryBookingID}", name="query_booking_modify")
       * @ParamConverter("queryBooking", options={"mapping": {"queryBookingID": "id"}})
       */
    ...
    /**
       * @Route("/querybooking/delete/{queryBookingID}", name="query_booking_delete")
       * @ParamConverter("queryBooking", options={"mapping": {"queryBookingID": "id"}})
       */
