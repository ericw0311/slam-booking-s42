...
class PlanificationFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    private function getData(): array
    {
        ...
        [478, 1, 550, 'PLACE', 1, 'ROOM', 'Réserver une Salle de Réunion'],
        ...
        [613, 1, 555, 'VEHICLE', 1, 'PLANE', '31ADU'],
        [614, 1, 321, 'VEHICLE', 1, 'BOAT', 'BOMBARD Semi rigide'],
        [615, 1, 321, 'TOOL', 1, 'COMPUTER', 'SPPA 2015 06 000 ...'],
        [616, 1, 538, 'USER', 1, 'TEACHER', 'BOLOT Daniel'],
    ];
    }
