...
class PlanificationPeriodFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    private function getData(): array
    {
        ...
        [655, 1, 477, '07/07/2017', '27/09/2018', 4],
        [657, 1, 569, 'NULL', '25/06/2019', 2],
        [669, 1, 478, '11/10/2017', '08/07/2019', 4],
        ...
        [731, 1, 477, '28/09/2018', '12/07/2019', 4],
        [734, 1, 288, '27/02/2015', 'NULL', 3],
        [735, 1, 293, '23/09/2014', 'NULL', 3],
        [737, 1, 437, '11/06/2019', 'NULL', 3],
        [738, 1, 613, 'NULL', 'NULL', 1],
        [739, 1, 614, 'NULL', 'NULL', 1],
        [740, 1, 615, 'NULL', 'NULL', 1],
        [741, 1, 478, '09/07/2019', 'NULL', 3],
        [742, 1, 477, '13/07/2019', 'NULL', 3],
        [743, 1, 616, 'NULL', 'NULL', 1],
    ];
    }
