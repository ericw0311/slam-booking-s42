...
class ResourceFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    private function getData(): array
    {
        ...
        [251, 1, 321, 'VEHICLE', 1, 'CAR', 'SCENIC - FA-725-NZ', 2478],
        [252, 1, 321, 'VEHICLE', 1, 'TRUCK', 'FIAT DUCATO', 2479],
        [253, 1, 321, 'TOOL', 1, 'COMPUTER', 'BOMBARD', 2486],
        ...
        [973, 1, 440, 'PLACE', 1, 'ROOM', '1_', 4585],
        ...
        [983, 1, 440, 'TOOL', 1, 'COMPUTER', 'Balance de précision KERN', 4598],
        ...
        [1412, 1, 523, 'PLACE', 1, 'ROOM', '15 ordinateurs HP - A prendre en salle de perm.', 6049],
        ...
        [1506, 1, 535, 'SPORT', 1, 'COURT', 'GAZON INUTILISABLE POUR LE MOMENT', 6329],
        [1524, 1, 538, 'VEHICLE', 1, 'PLANE', 'DR480 F-HNNG', 6372],
        [1525, 1, 538, 'VEHICLE', 1, 'PLANE', 'DV20 F-GNJD', 6372],
        [1543, 1, 538, 'USER', 1, 'TEACHER', 'BOLOT Daniel', 6381],
        ...
        [2722, 1, 523, 'PLACE', 1, 'ROOM', '16 ordinateurs portables LENOVO (vie scolaire)', 6049],
        ...
        [3033, 1, 523, 'PLACE', 1, 'ROOM', 'Techno', 6049],
        [3064, 1, 555, 'VEHICLE', 1, 'PLANE', '31ADU', 6708],
        [3066, 1, 321, 'VEHICLE', 1, 'BOAT', 'BOMBARD Semi-rigide', 2483],
        [3073, 1, 321, 'TOOL', 1, 'COMPUTER', 'SPPA 2015-06-000', 2486],
        [3074, 1, 321, 'TOOL', 1, 'COMPUTER', 'SPPA 2017-02-001', 2486],
        [3075, 1, 321, 'TOOL', 1, 'COMPUTER', 'SPPA 2017-02-002', 2486],
        [3076, 1, 321, 'TOOL', 1, 'COMPUTER', 'SPPA Maquette', 2486],
        [1586, 1, 550, 'PLACE', 1, 'ROOM', 'Serveur/Ne pas réserver', 6625],
        [1587, 1, 550, 'PLACE', 1, 'ROOM', 'Venise', 11770],
        [1588, 1, 550, 'PLACE', 1, 'ROOM', 'New York', 11770],
        [1589, 1, 550, 'PLACE', 1, 'ROOM', 'Tokyo', 11770],
        [1947, 1, 550, 'PLACE', 1, 'ROOM', 'Réunion/Ateliers', 6625],
        [2686, 1, 550, 'PLACE', 1, 'ROOM', 'Lima', 11770],
        [2705, 1, 550, 'PLACE', 1, 'ROOM', 'Berlin', 11770],
        [2706, 1, 550, 'PLACE', 1, 'ROOM', 'Alain/Ne pas réserver', 11770],
        [2707, 1, 550, 'PLACE', 1, 'ROOM', 'Olivier/Ne pas réserver', 11770],
        [2708, 1, 550, 'PLACE', 1, 'ROOM', 'Paris', 11770],
        [2882, 1, 550, 'PLACE', 1, 'ROOM', 'Bureau PMR-Salle Rdc', 11770],
        [2999, 1, 550, 'PLACE', 1, 'ROOM', 'Vancouver', 11770],
        [3010, 1, 550, 'PLACE', 1, 'ROOM', 'JB/Ne pas réserver', 11770],
        [3088, 1, 550, 'PLACE', 1, 'ROOM', 'Téléphone', 6625],
    ];
    }

    public function getDependencies()
    {
        return array(FileFixtures::class, UserFixtures::class, ResourceClassification_iFixtures::class);
    }
}
