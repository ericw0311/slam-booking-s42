...
class UserFileFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    private function getData(): array
    {
        ...
        [1184, 555, 1, 1049, 1, 0, 0],
        [1185, 555, 1, 1050, 1, 0, 0],
        ...
        [2037, 555, 0, 2067, 1, 0, 0],
        [2038, 555, 0, 2068, 1, 0, 0],
        [2039, 555, 0, 2080, 1, 0, 0],
        [2041, 550, 0, 2085, 1, 0, 0],
        [2042, 550, 0, 2086, 1, 0, 0],
        [2043, 507, 0, 2087, 1, 0, 0],
        [2044, 550, 0, 2088, 1, 0, 0],
        [764, 440, 0, 575, 1, 0, 0],
        [2047, 550, 0, 2089, 1, 0, 0],
        [2048, 321, 0, 2048, 1, 0, 0],
        [2049, 550, 0, 2090, 1, 0, 0],
        [1180, 555, 0, 2091, 1, 0, 0],
        [2050, 321, 0, 2092, 1, 0, 0],
        [2051, 535, 0, 2093, 1, 0, 0],
        [2052, 535, 0, 2094, 1, 0, 0],
        [2053, 550, 0, 2095, 1, 0, 0],
        [2054, 550, 0, 2096, 1, 0, 0],
        [2057, 523, 0, 2097, 1, 0, 0],
        [2058, 523, 0, 2098, 1, 0, 0],
        [2059, 523, 0, 2099, 1, 0, 0],
        [2060, 523, 0, 2100, 1, 0, 0],
        [2061, 523, 0, 2101, 1, 0, 0],
        [2062, 507, 0, 2102, 1, 0, 0],
        [2063, 550, 0, 2103, 1, 0, 0],
        [2065, 523, 0, 2104, 1, 0, 0],
        [2066, 523, 0, 2105, 1, 0, 0],
        [2067, 523, 0, 2106, 1, 0, 0],
        [2068, 523, 0, 2107, 1, 0, 0],
        [1418, 614, 1, 1302, 1, 0, 0],
        [552, 321, 0, 279, 1, 1, 654],
        [1104, 538, 0, 963, 1, 1, 1543],
