...
class ResourceClassification
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="file")
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Resource", mappedBy="classification", orphanRemoval=true)
     */
    private $resources;
    ...
    */
    ...
    public function addResource(Resource $resource): self
    {
        if (!$this->resources->contains($resource)) {
            ...
            $resource->setClassification($this);
        }
    ...
    public function removeResource(Resource $resource): self
    {
        if ($this->resources->contains($resource)) {
            ...
            if ($resource->getClassification() === $this) {
