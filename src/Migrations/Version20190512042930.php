 ...
 */
final class Version20190512042930 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, user_name VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(64) NOT NULL, roles JSON NOT NULL, account_type VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, unique_name VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D64924A232CF (user_name), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_file (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, account_id INT DEFAULT NULL, file_id INT NOT NULL, resource_id INT DEFAULT NULL, email VARCHAR(255) NOT NULL, account_type VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, unique_name VARCHAR(255) DEFAULT NULL, administrator TINYINT(1) NOT NULL, active TINYINT(1) NOT NULL, user_created TINYINT(1) NOT NULL, user_name VARCHAR(255) DEFAULT NULL, resource_user TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_F61E7AD9A76ED395 (user_id), INDEX IDX_F61E7AD99B6B5FBA (account_id), INDEX IDX_F61E7AD993CB796C (file_id), UNIQUE INDEX UNIQ_F61E7AD989329D25 (resource_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
